...
{
    public class VrgdaSystemServiceResource : SystemResource
    {
        public VrgdaSystemServiceResource() : base("VrgdaSystem") { }
    }
    public partial class VrgdaSystemService: ISystemService<VrgdaSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<VrgdaSystemServiceResource, VrgdaSystemService>();
            }
        }
        ...
        {
            return new VrgdaSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new VrgdaSystemDeployment();
