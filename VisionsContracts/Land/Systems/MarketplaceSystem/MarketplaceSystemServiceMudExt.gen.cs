...
{
    public class MarketplaceSystemServiceResource : SystemResource
    {
        public MarketplaceSystemServiceResource() : base("MarketplaceSystem") { }
    }
    public partial class MarketplaceSystemService: ISystemService<MarketplaceSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<MarketplaceSystemServiceResource, MarketplaceSystemService>();
            }
        }
        ...
        {
            return new MarketplaceSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new MarketplaceSystemDeployment();
