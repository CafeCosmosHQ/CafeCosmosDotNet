...
{
    public class LandTablesAndChairsContractServiceResource : SystemResource
    {
        public LandTablesAndChairsContractServiceResource() : base("LandTablesAndChairsContract") { }
    }
    public partial class LandTablesAndChairsContractService: ISystemService<LandTablesAndChairsContractServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandTablesAndChairsContractServiceResource, LandTablesAndChairsContractService>();
            }
        }
        ...
        {
            return new LandTablesAndChairsContractDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandTablesAndChairsContractDeployment();
