...
{
    public class LandScenarioUserTestingSystemServiceResource : SystemResource
    {
        public LandScenarioUserTestingSystemServiceResource() : base("LandScenarioUserTestingSystem") { }
    }
    public partial class LandScenarioUserTestingSystemService: ISystemService<LandScenarioUserTestingSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandScenarioUserTestingSystemServiceResource, LandScenarioUserTestingSystemService>();
            }
        }
        ...
        {
            return new LandScenarioUserTestingSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandScenarioUserTestingSystemDeployment();
