...
{
    public class LandTransformServiceResource : SystemResource
    {
        public LandTransformServiceResource() : base("LandTransform") { }
    }
    public partial class LandTransformService: ISystemService<LandTransformServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandTransformServiceResource, LandTransformService>();
            }
        }
        ...
        {
            return new LandTransformDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandTransformDeployment();
