...
{
    public class LandQuestsSystemServiceResource : SystemResource
    {
        public LandQuestsSystemServiceResource() : base("LandQuestsSystem") { }
    }
    public partial class LandQuestsSystemService: ISystemService<LandQuestsSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandQuestsSystemServiceResource, LandQuestsSystemService>();
            }
        }
        ...
        {
            return new LandQuestsSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandQuestsSystemDeployment();
