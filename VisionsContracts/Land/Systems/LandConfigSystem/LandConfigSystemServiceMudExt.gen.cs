...
{
    public class LandConfigSystemServiceResource : SystemResource
    {
        public LandConfigSystemServiceResource() : base("LandConfigSystem") { }
    }
    public partial class LandConfigSystemService: ISystemService<LandConfigSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandConfigSystemServiceResource, LandConfigSystemService>();
            }
        }
        ...
        {
            return new LandConfigSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandConfigSystemDeployment();
