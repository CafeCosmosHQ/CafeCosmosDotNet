...
{
    public class LevelingSystemServiceResource : SystemResource
    {
        public LevelingSystemServiceResource() : base("LevelingSystem") { }
    }
    public partial class LevelingSystemService: ISystemService<LevelingSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LevelingSystemServiceResource, LevelingSystemService>();
            }
        }
        ...
        {
            return new LevelingSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LevelingSystemDeployment();
