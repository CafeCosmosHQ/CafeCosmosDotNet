...
{
    public class LandViewSystemServiceResource : SystemResource
    {
        public LandViewSystemServiceResource() : base("LandViewSystem") { }
    }
    public partial class LandViewSystemService: ISystemService<LandViewSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandViewSystemServiceResource, LandViewSystemService>();
            }
        }
        ...
        {
            return new LandViewSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandViewSystemDeployment();
