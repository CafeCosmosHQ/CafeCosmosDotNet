...
{
    public class TransformationsSystemServiceResource : SystemResource
    {
        public TransformationsSystemServiceResource() : base("TransformationsSystem") { }
    }
    public partial class TransformationsSystemService: ISystemService<TransformationsSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<TransformationsSystemServiceResource, TransformationsSystemService>();
            }
        }
        ...
        {
            return new TransformationsSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new TransformationsSystemDeployment();
