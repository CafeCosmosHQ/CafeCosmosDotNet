...
{
    public class QuestsSystemServiceResource : SystemResource
    {
        public QuestsSystemServiceResource() : base("QuestsSystem") { }
    }
    public partial class QuestsSystemService: ISystemService<QuestsSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<QuestsSystemServiceResource, QuestsSystemService>();
            }
        }
        ...
        {
            return new QuestsSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new QuestsSystemDeployment();
