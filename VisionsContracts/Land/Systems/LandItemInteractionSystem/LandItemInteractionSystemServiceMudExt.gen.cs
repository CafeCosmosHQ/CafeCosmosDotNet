...
{
    public class LandItemInteractionSystemServiceResource : SystemResource
    {
        public LandItemInteractionSystemServiceResource() : base("LandItemInteractionSystem") { }
    }
    public partial class LandItemInteractionSystemService: ISystemService<LandItemInteractionSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandItemInteractionSystemServiceResource, LandItemInteractionSystemService>();
            }
        }
        ...
        {
            return new LandItemInteractionSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandItemInteractionSystemDeployment();
