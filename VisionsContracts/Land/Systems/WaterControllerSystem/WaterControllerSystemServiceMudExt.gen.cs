...
{
    public class WaterControllerSystemServiceResource : SystemResource
    {
        public WaterControllerSystemServiceResource() : base("WaterControllerSystem") { }
    }
    public partial class WaterControllerSystemService: ISystemService<WaterControllerSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<WaterControllerSystemServiceResource, WaterControllerSystemService>();
            }
        }
        ...
        {
            return new WaterControllerSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new WaterControllerSystemDeployment();
