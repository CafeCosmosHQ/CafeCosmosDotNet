...
{
    public class LandTokensSystemServiceResource : SystemResource
    {
        public LandTokensSystemServiceResource() : base("LandTokensSystem") { }
    }
    public partial class LandTokensSystemService: ISystemService<LandTokensSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<LandTokensSystemServiceResource, LandTokensSystemService>();
            }
        }
        ...
        {
            return new LandTokensSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new LandTokensSystemDeployment();
