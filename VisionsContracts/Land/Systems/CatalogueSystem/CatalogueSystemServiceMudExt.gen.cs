...
{
    public class CatalogueSystemServiceResource : SystemResource
    {
        public CatalogueSystemServiceResource() : base("CatalogueSystem") { }
    }
    public partial class CatalogueSystemService: ISystemService<CatalogueSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<CatalogueSystemServiceResource, CatalogueSystemService>();
            }
        }
        ...
        {
            return new CatalogueSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new CatalogueSystemDeployment();
