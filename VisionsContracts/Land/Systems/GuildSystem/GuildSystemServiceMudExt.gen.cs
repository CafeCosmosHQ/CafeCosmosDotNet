...
{
    public class GuildSystemServiceResource : SystemResource
    {
        public GuildSystemServiceResource() : base("GuildSystem") { }
    }
    public partial class GuildSystemService: ISystemService<GuildSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<GuildSystemServiceResource, GuildSystemService>();
            }
        }
        ...
        {
            return new GuildSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public virtual Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new GuildSystemDeployment();
